...
public class TstCriacaoRendimento {
   ...
   public TstCriacaoRendimento(int agencia, int conta, double saldoAbertura, double valorTransacao, double saldo) {
		super();
	...
	public void testRendimento() throws ValorEmBrancoException {
		double valor = this.cc.criarReceita(valorTransacao);
